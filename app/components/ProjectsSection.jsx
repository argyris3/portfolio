...
const projectsData = [
  ...
  },
  {
    ...
    title: "blog-project",
    description:
      "a multi interactive blog with news comments authentication and admin dashboard",
...
const ProjectsSection = () => {
  ...
  return (
    <section>
      <h2 className="text-purple-400 text-center text-6xl font-semibold mt-4 mb-8 md:mb-12">
        My Projects
      </h2>
